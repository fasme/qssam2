...
public function informeevidenciamensual()
{
    ...
    $actividadresponsable = DB::table('actividad_responsable_noprogramada')->join("actividad_noprogramada","actividad_responsable_noprogramada.actividad_id","=","actividad_noprogramada.id")->Where(DB::raw("MONTH(actividad_responsable_noprogramada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_noprogramada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_admin_id","=",Auth::user()->id)->count("*");
 $actividadresponsable_kpi = DB::table('actividad_kpi')->join("kpi","actividad_kpi.kpi_id","=","kpi.id")->Where(DB::raw("MONTH(actividad_kpi.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_kpi.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_programada = DB::table('actividad_responsable_programada')->join("actividad_programada","actividad_responsable_programada.actividad_id","=","actividad_programada.id")->Where(DB::raw("MONTH(actividad_responsable_programada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_programada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_pac = DB::table('actividad_pac')->join("pac","actividad_pac.pac_id","=","pac.id")->Where(DB::raw("MONTH(actividad_pac.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_pac.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_admin_id","=",Auth::user()->id)->count("*");
...
$abiertas = $actividadresponsable + $actividadresponsable_kpi + $actividadresponsable_programada + $actividadresponsable_pac + $actividadresponsable_mantencion;
    ...
    $actividadresponsable = DB::table('actividad_responsable_noprogramada')->join("actividad_noprogramada","actividad_responsable_noprogramada.actividad_id","=","actividad_noprogramada.id")->Where(DB::raw("MONTH(actividad_responsable_noprogramada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_noprogramada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_admin_id","=",Auth::user()->id)->count("*");
 $actividadresponsable_kpi = DB::table('actividad_kpi')->join("kpi","actividad_kpi.kpi_id","=","kpi.id")->Where(DB::raw("MONTH(actividad_kpi.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_kpi.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_programada = DB::table('actividad_responsable_programada')->join("actividad_programada","actividad_responsable_programada.actividad_id","=","actividad_programada.id")->Where(DB::raw("MONTH(actividad_responsable_programada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_programada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_pac = DB::table('actividad_pac')->join("pac","actividad_pac.pac_id","=","pac.id")->Where(DB::raw("MONTH(actividad_pac.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_pac.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_admin_id","=",Auth::user()->id)->count("*");
...
public function informeevidenciaanualpersonal(){
   ...
   $actividadresponsable = DB::table('actividad_responsable_noprogramada')->join("actividad_noprogramada","actividad_responsable_noprogramada.actividad_id","=","actividad_noprogramada.id")->Where(DB::raw("MONTH(actividad_responsable_noprogramada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_noprogramada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
 $actividadresponsable_kpi = DB::table('actividad_kpi')->join("kpi","actividad_kpi.kpi_id","=","kpi.id")->Where(DB::raw("MONTH(actividad_kpi.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_kpi.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_programada = DB::table('actividad_responsable_programada')->join("actividad_programada","actividad_responsable_programada.actividad_id","=","actividad_programada.id")->Where(DB::raw("MONTH(actividad_responsable_programada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_programada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_pac = DB::table('actividad_pac')->join("pac","actividad_pac.pac_id","=","pac.id")->Where(DB::raw("MONTH(actividad_pac.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_pac.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->where("actividad_pac.personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
...
$abiertas[] = $actividadresponsable + $actividadresponsable_kpi + $actividadresponsable_programada + $actividadresponsable_pac + $actividadresponsable_mantencion;
    ...
    $actividadresponsable = DB::table('actividad_responsable_noprogramada')->join("actividad_noprogramada","actividad_responsable_noprogramada.actividad_id","=","actividad_noprogramada.id")->Where(DB::raw("MONTH(actividad_responsable_noprogramada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_noprogramada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
 $actividadresponsable_kpi = DB::table('actividad_kpi')->join("kpi","actividad_kpi.kpi_id","=","kpi.id")->Where(DB::raw("MONTH(actividad_kpi.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_kpi.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_programada = DB::table('actividad_responsable_programada')->join("actividad_programada","actividad_responsable_programada.actividad_id","=","actividad_programada.id")->Where(DB::raw("MONTH(actividad_responsable_programada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_programada.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_pac = DB::table('actividad_pac')->join("pac","actividad_pac.pac_id","=","pac.id")->Where(DB::raw("MONTH(actividad_pac.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_pac.frecuencia)"),"=",$data["ano"])->Where("estado","=","Cerrada")->where("actividad_pac.personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
...
$cerradas[] = $actividadresponsable + $actividadresponsable_kpi + $actividadresponsable_programada + $actividadresponsable_pac + $actividadresponsable_mantencion;
    ...
    $actividadresponsable = DB::table('actividad_responsable_noprogramada')->join("actividad_noprogramada","actividad_responsable_noprogramada.actividad_id","=","actividad_noprogramada.id")->Where(DB::raw("MONTH(actividad_responsable_noprogramada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_noprogramada.frecuencia)"),"=",$data["ano"])->Where("actividad_responsable_noprogramada.frecuencia",">","fechaenvio")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
 $actividadresponsable_kpi = DB::table('actividad_kpi')->join("kpi","actividad_kpi.kpi_id","=","kpi.id")->Where(DB::raw("MONTH(actividad_kpi.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_kpi.frecuencia)"),"=",$data["ano"])->Where("actividad_kpi.frecuencia",">","fechaenvio")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_programada = DB::table('actividad_responsable_programada')->join("actividad_programada","actividad_responsable_programada.actividad_id","=","actividad_programada.id")->Where(DB::raw("MONTH(actividad_responsable_programada.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_responsable_programada.frecuencia)"),"=",$data["ano"])->Where("actividad_responsable_programada.frecuencia",">","fechaenvio")->where("personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
$actividadresponsable_pac = DB::table('actividad_pac')->join("pac","actividad_pac.pac_id","=","pac.id")->Where(DB::raw("MONTH(actividad_pac.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_pac.frecuencia)"),"=",$data["ano"])->Where("actividad_pac.frecuencia",">","fechaenvio")->where("actividad_pac.personal_id","=",$data["personal"])->where("personal_admin_id","=",Auth::user()->id)->count("*");
