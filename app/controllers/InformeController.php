...
public function informeevidenciamensual()
{
 ...
 $actividadresponsable_kpi = DB::table('actividad_kpi')->join("actividad_kpi","actividad_responsable_kpi.actividad_id","=","actividad_kpi.id")->Where(DB::raw("MONTH(actividad_kpi.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_kpi.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->count("*");
...
$actividadresponsable_pac = DB::table('actividad_pac')->join("actividad_pac","actividad_responsable_pac.actividad_id","=","actividad_pac.id")->Where(DB::raw("MONTH(actividad_pac.frecuencia)"),"=",$data["mes"])->where(DB::raw("YEAR(actividad_pac.frecuencia)"),"=",$data["ano"])->Where("estado","=","Abierta")->count("*");
