...
{{ Form::open($form_data) }}
            ...
            {{Form::select('perfil', array("usuario"=>"usuario General", "usuariobodega"=>"Usuario Bodega","adminbodega"=>"Admin Bodega", "admin"=>"Admin General", "adminprevencion"=>"Administrador De Prevencion", "admingerente"=>"Gerencial", "liderdearea"=>"Lider de Area"), $personal->perfil)}}
            </div>
